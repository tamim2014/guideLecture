   ...
   */
   ...
   function nouvelleTable(){
        ...
        if(nomJour !== 'Dimanche'){ // la dernière table disparaît le Dimanche; afin de rapler q'i fo recharger l'espace mémoire pour LUNDI
		    ...
		    html += '<tr class="t1ligne1"><td colspan="7">On est Dimanche.</td></tr> \
				 '+rappel+'\
				 <tr class="t1ligne8"><td id="messageGirofar" colspan="7" style="padding:3.3%;  text-align:center;">T\'as pas encore copié la dernière table !</td></tr></table>'; 	   
